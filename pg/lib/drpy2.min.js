...
`, {
        outputEncoding: "base64",
        options: {environment: "browser", encryptionScheme: {scheme: "pkcs1_oaep", hash: "sha256"}}
    });
...
-----END RSA PRIVATE KEY-----`, {options: {environment: "browser", encryptionScheme: "pkcs1_oaep"}});
    console.log("decryptedWithPrivate");
    console.log(decryptedWithPrivate);
    (() => {
...
Object.defineProperty(Array.prototype, "append", {value: Array.prototype.push, enumerable: false});
Object.defineProperty(String.prototype, "strip", {value: String.prototype.trim, enumerable: false});
...
function reqCookie(url, obj, all_cookie) {
    ...
    html = json.body;
    return {cookie: cookie, html: html}
}
...
function getOriginalJs(js_code) {
    ...
    function aes_decrypt(data) {
        ...
        let encrypted = CryptoJS.AES.decrypt({ciphertext: CryptoJS.enc.Base64.parse(data)}, key, {
            iv: iv,
            mode: CryptoJS.mode.CBC,
            padding: CryptoJS.pad.Pkcs7
        }).toString(CryptoJS.enc.Utf8);
