...
var iｉl = "jsjiami.com.v6",
  ...
  lIIIl1ll = [
    iｉl,
    "\x6f\x6b\x68\x74\x74\x70\x2f\x33\x2e\x31\x35",
    ...
    "\x3a\x2f\x2f",
    "\x6c\x6f\x67",
    "\x70\x69\x63\x55\x72\x6c\x3a\x20",
    "\x72\x65\x70\x6c\x61\x63\x65",
    "\x70\x75\x73\x68",
    "\x2f\x66\x69\x6c\x65\x2f\x6c\x69\x76\x65\x73\x6f\x75\x72\x63\x65\x6c\x69\x73\x74",
    "\x2f\x6c\x69\x76\x65\x73\x6f\x75\x72\x63\x65\x6c\x69\x73\x74",
    "\x47\x45\x54",
    "\x70\x61\x72\x73\x65",
    ...
    "\x6e\x61\x6d\x65",
    "\x75\x72\x6c",
    "\x3d\x3d\x3d\x3d\x20\x3e\x3e\x3e\x20",
    "\x73\x74\x72\x69\x6e\x67\x69\x66\x79",
    "\x65\x78\x65\x63",
    "\x74\x65\x73\x74",
    "\x6d\x61\x74\x63\x68",
    "\x63\x68\x61\x6e\x6e\x65\x6c",
    "\x2c\x23\x67\x65\x6e\x72\x65\x23\x0a",
    "\x75\x72\x6c\x73",
    "\x64\x61\x74\x61",
    ...
    "\x2d\x2d\x2d",
    "\x6c\x69\x6e\x65",
    "\x77\x65\x62\x50\x69\x63\x55\x72\x6c\x3a\x20",
    "\x23\x45\x58\x54\x4d\x33\x55",
    "\x22\x63\x68\x61\x6e\x6e\x65\x6c\x22",
    "\x22\x75\x72\x6c\x73\x22",
    "\x22\x64\x61\x74\x61\x6c\x69\x73\x74\x22",
    "\x6c\x65\x6e\x67\x74\x68",
    "\x23\x67\x65\x6e\x72\x65\x23",
    "\x7b\x6e\x61\x6d\x65\x7d",
    "\x7b\x63\x61\x74\x65\x7d",
    "\u76f4\u64ad\u5217\u8868",
    "\x6e\x75\x6c\x6c",
    "\x74\x79\x70\x65\x5f\x69\x64",
    "\x76\x6f\x64\x5f\x70\x6c\x61\x79\x5f\x75\x72\x6c",
    "\x68\x61\x73\x4f\x77\x6e\x50\x72\x6f\x70\x65\x72\x74\x79",
    "\x6a\x6f\x69\x6e",
    "\x76\x6f\x64\x5f\x70\x6c\x61\x79\x5f\x66\x72\x6f\x6d",
    "\x6a\x43\x50\x73\x4e\x6a\x77\x69\x4a\x61\x51\x6d\x69\x2e\x63\x6f\x4e\x4f\x6d\x47\x72\x2e\x76\x56\x36\x41\x46\x67\x79\x74\x74\x3d\x3d",
  ];
...
(function (_0x209161, _0x5eaa4a) {
  var _0x42ecdf = 0x0;
  for (
    _0x5eaa4a = _0x209161["shift"](_0x42ecdf >> 0x2);
    _0x5eaa4a &&
    _0x5eaa4a !==
      (_0x209161["pop"](_0x42ecdf >> 0x3) + "")["replace"](
        /[CPNwJQNOGrVAFgytt=]/g,
        ""
      );
    _0x42ecdf++
...
let headers = { "User-Agent": Ii1l1III("0") };
let classes = [];
let cates = {};
let picUrl = "";
let webPaths = {};
  ...
  for (const IlII1I1 of IIlIlI1I) {
    if (IlII1I1[Ii1l1III("1")]("\x24") > 0x0) {
      ...
      try {
        ...
        let lillI11l = II1lIlli[Ii1l1III("10")](
          0x0,
          II1lIlli[Ii1l1III("11")]("\x2f") + 0x1
        );
        for (const i1iilII1 of l1lIiill) {
          ...
          let illIl111 =
            Iillil +
            "\x24" +
            (lI1iIl[Ii1l1III("1")](Ii1l1III("6")) < 0x0 ? lillI11l : "") +
            lI1iIl;
          classes[Ii1l1III("a")]({
            type_id: illIl111,
...
function home(I1iiIiIl) {
  return JSON[Ii1l1III("15")]({ class: classes, filters: null });
}
...
function getCateData(IliI1i) {
  ...
  if (!cates[IliI1i]) {
    ...
    if (I111lilI[Ii1l1III("1")](Ii1l1III("23")) >= 0x0) {
      ...
      I111lilI[Ii1l1III("1")](Ii1l1III("24")) > 0x0 &&
      I111lilI[Ii1l1III("1")](Ii1l1III("25")) > 0x0
    ) {
      I111lilI = parseFm(I111lilI);
    } else if (
      I111lilI[Ii1l1III("1")](Ii1l1III("26")) > 0x0 &&
      I111lilI[Ii1l1III("1")](Ii1l1III("25")) > 0x0
    ) {
      I111lilI = parseLu(I111lilI);
    }
    let li1IiiII = (i1I1l1i + "\x0a" + I111lilI[Ii1l1III("9")]("\x0d", ""))[
      Ii1l1III("3")
    ]("\x0a");
    let lli11iI = i1I1l1i;
    let IiiIIiIi = null;
    ...
    for (let i1ii1IIl = 0x0; i1ii1IIl < li1IiiII[Ii1l1III("27")]; i1ii1IIl++) {
      ...
      if (
        lIliIii != "" &&
        lIliIii[Ii1l1III("1")](Ii1l1III("6")) < 0x0 &&
        (lIliIii[Ii1l1III("1")]("\x2c") < 0x0 ||
          lIliIii[Ii1l1III("1")](Ii1l1III("28")) > 0x0)
      ) {
        if (iiiI1l != "") {
          let ilIIIl = iI1I1I1I[Ii1l1III("9")](
            Ii1l1III("29"),
            encodeURIComponent(lli11iI)
          )[Ii1l1III("9")](Ii1l1III("2a"), encodeURIComponent(i1I1l1i));
          ...
          if (ilI1ilI > -0x1 && iili1I1i > ilI1ilI) {
            ...
            let lii11liI = lli11iI[Ii1l1III("9")](
              I1liliII,
              function (Ili1lIi1, iiliII1l) {
                return iiliII1l;
              }
            );
        ...
        lIliIii[Ii1l1III("1")]("\x2c") > 0x0 &&
        /http|rtmp|rtsp|rsp/[Ii1l1III("17")](lIliIii)
      ) {
        ...
        iiiI1l +=
          l1iiI1ii[0x0][Ii1l1III("4")]() +
          "\x24" +
          l1iiI1ii[0x1][Ii1l1III("4")]();
      }
    }
    if (iiiI1l != "") {
      let II1Iliil = iI1I1I1I[Ii1l1III("9")](
        Ii1l1III("29"),
        encodeURIComponent(lli11iI)
      )[Ii1l1III("9")](Ii1l1III("2a"), encodeURIComponent(i1I1l1i));
      ...
      if (ilI1ilI > -0x1 && iili1I1i > ilI1ilI) {
        ...
        let I1liliII = new RegExp(I11Ilili[Ii1l1III("9")](/<|>/g, ""));
        let lii11liI = I1liliII[Ii1l1III("17")](lli11iI)
          ? lli11iI[Ii1l1III("18")](I1liliII)[0x1]
          : Ii1l1III("2c");
...
function homeVod(liIIlIl1) {
  ...
  let I1l1iil = JSON[Ii1l1III("15")]({ list: iIl1IIii });
  return I1l1iil;
}
function category(I1l1i1Ii, l1IiiIli, IIi1Illi, lilIliIl) {
  ...
  let iIiiIi1i = JSON[Ii1l1III("15")]({ list: IIi1i1ll });
  return iIiiIi1i;
}
function detail(lIl11iii) {
  ...
  if (l1l111II[Ii1l1III("1")]("\x21\x21") >= 0x0) {
    ...
    for (const i1IiIlIl of ii1l1iil) {
      ...
      IIiIII11 =
        l1l111II + (i1Ili1I[Ill1iii1] > 0x1 ? "\x20" + i1Ili1I[Ill1iii1] : "");
      if (!IIIllli1[Ii1l1III("2f")](IIiIII11)) {
        IIIllli1[IIiIII11] = [];
      }
      IIIllli1[IIiIII11][Ii1l1III("a")](
        Ill1iii1 + "\x24" + i1IiIlIl[Ii1l1III("3")]("\x24")[0x1]
      );
    }
    let III1i1ii = [];
    let iii1lIIi = [];
  ...
  return JSON[Ii1l1III("15")]({ list: [Iill11Ii] });
}
function play(l1llIIii, illiiIII, lIIIiIiI) {
  return JSON[Ii1l1III("15")]({ parse: 0x0, url: illiiIII });
}
